...
val PhIcons.Light.WifiSlashLight: ImageVector
    get() {
        if (_WifiSlashLight != null) {
            return _WifiSlashLight!!
        }
        _WifiSlashLight = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(200f, 129f)
                arcToRelative(115.57f, 115.57f, 0f, isMoreThanHalf = false, isPositiveArc = false, -48.38f, -22.63f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 12f,
