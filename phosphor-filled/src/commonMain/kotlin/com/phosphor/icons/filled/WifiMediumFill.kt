...
val PhIcons.Filled.WifiMediumFill: ImageVector
    get() {
        if (_WifiMediumFill != null) {
            return _WifiMediumFill!!
        }
        _WifiMediumFill = ImageVector.Builder(
            name = "Filled.WifiMediumFill",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 256f,
            viewportHeight = 256f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(15.93f, 15.93f, 0f, isMoreThanHalf = false, isPositiveArc = false, -6.17f, -10.81f)
