...
val PhIcons.Filled.LinkSimpleHorizontalBreakFill: ImageVector
    get() {
        if (_LinkSimpleHorizontalBreakFill != null) {
            return _LinkSimpleHorizontalBreakFill!!
        }
        _LinkSimpleHorizontalBreakFill = ImageVector.Builder(
            name = "Filled.LinkSimpleHorizontalBreakFill",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 256f,
            viewportHeight = 256f
