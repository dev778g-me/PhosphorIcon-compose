...
kotlin {
    androidLibrary {
        namespace = "com.phosphor.icons.regular"
        compileSdk = 36
        minSdk = 24
    }
...
mavenPublishing {
    coordinates(
        ...
        artifactId = "phosphoricons-regular",
        version = "1.0.4"
    )

    pom {
        name.set("phosphoricons-regular")
        description.set("Phosphor icon library - regular variant for Compose Multiplatform")
