...
val PhIcons.Filled.CloudSunFill: ImageVector
    get() {
        if (_CloudSunFill != null) {
            return _CloudSunFill!!
        }
        _CloudSunFill = ImageVector.Builder(
            name = "Filled.CloudSunFill",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 256f,
            viewportHeight = 256f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(55.63f, 55.63f, 0f, isMoreThanHalf = false, isPositiveArc = false, -9.41f, -11.54f)
