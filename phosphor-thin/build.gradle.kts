...
kotlin {
    androidLibrary {
        namespace = "com.phosphor.icons.thin"
        compileSdk = 36
        minSdk = 24
    }
...
mavenPublishing {
    coordinates(
        ...
        artifactId = "phosphoricons-thin",
        version = publishVersion
    )

    pom {
        name.set("phosphoricons-thin")
        description.set("Phosphor icon library - thin variant for Compose Multiplatform")
