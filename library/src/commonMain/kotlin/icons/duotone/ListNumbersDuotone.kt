...
val PhIcons.Duotone.ListNumbersDuotone: ImageVector
    get() {
        if (_ListNumbersDuotone != null) {
            return _ListNumbersDuotone!!
        }
        _ListNumbersDuotone = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(15.69f, 15.69f, 0f, isMoreThanHalf = false, isPositiveArc = false, -3.24f, -22.41f)
