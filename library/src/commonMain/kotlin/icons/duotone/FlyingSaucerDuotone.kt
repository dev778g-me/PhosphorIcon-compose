...
val PhIcons.Duotone.FlyingSaucerDuotone: ImageVector
    get() {
        if (_FlyingSaucerDuotone != null) {
            return _FlyingSaucerDuotone!!
        }
        _FlyingSaucerDuotone = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(195.87f, 195.87f, 0f, isMoreThanHalf = false, isPositiveArc = true, -43.65f, -4.58f)
            ...
            path(
                ...
                arcToRelative(195.71f, 195.71f, 0f, isMoreThanHalf = false, isPositiveArc = false, 43.64f, -4.58f)
