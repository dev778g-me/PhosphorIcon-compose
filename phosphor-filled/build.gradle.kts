...
kotlin {
    androidLibrary {
        namespace = "com.phosphor.icons.filled"
        compileSdk = 36
        minSdk = 24
    }
...
mavenPublishing {
    coordinates(
        ...
        artifactId = "phosphoricons-filled",
        version = publishVersion
    )

    pom {
        name.set("phosphoricons-filled")
        description.set("Phosphor icon library - filled variant for Compose Multiplatform")
