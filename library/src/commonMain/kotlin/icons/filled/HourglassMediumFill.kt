...
val PhIcons.Filled.HourglassMediumFill: ImageVector
    get() {
        if (_HourglassMediumFill != null) {
            return _HourglassMediumFill!!
        }
        _HourglassMediumFill = ImageVector.Builder(
            name = "Filled.HourglassMediumFill",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 256f,
            viewportHeight = 256f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(16f, 16f, 0f, isMoreThanHalf = false, isPositiveArc = false, 16f, -16f)
                lineTo(200f, 180.36f)
                arcToRelative(16.09f, 16.09f, 0f, isMoreThanHalf = false, isPositiveArc = false, -6.35f, -12.77f)
                lineTo(141.27f, 128f)
