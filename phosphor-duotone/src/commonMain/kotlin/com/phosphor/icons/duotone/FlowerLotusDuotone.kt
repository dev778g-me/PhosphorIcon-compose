...
val PhIcons.Duotone.FlowerLotusDuotone: ImageVector
    get() {
        if (_FlowerLotusDuotone != null) {
            return _FlowerLotusDuotone!!
        }
        _FlowerLotusDuotone = ImageVector.Builder(
            name = "Duotone.FlowerLotusDuotone",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 256f,
            viewportHeight = 256f
            ...
            path(
                ...
                moveTo(88f, 119.18f)
                arcToRelative(108.49f, 108.49f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6.61f, -38.36f)
