...
val PhIcons.Duotone.RacquetDuotone: ImageVector
    get() {
        if (_RacquetDuotone != null) {
            return _RacquetDuotone!!
        }
        _RacquetDuotone = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(63.61f, 79.51f, 45f, isMoreThanHalf = true, isPositiveArc = false, 112.44f, -112.44f)
                arcToRelative(63.61f, 79.51f, 45f, isMoreThanHalf = true, isPositiveArc = false, -112.44f, 112.44f)
                close()
            }
            path(
